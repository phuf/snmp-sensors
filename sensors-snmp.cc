...
static RETSIGTYPE stop_server(int a) { keep_running = 0; }

static void usage(void) {
    printf("usage: ifTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING "
           "ADDRESSES]\n"
           ...
           "\t\tundesrstood by the agent and then exit.\n"
...
int main(int argc, char **argv) {
    ...
    int agentx_subagent =
        0; /* change this if you want to be a SNMP master agent */
    int ch;
    extern char *optarg;
    ...
    while ((ch = getopt(argc, argv, "D:fHLM")) != EOF)
        ...
        case 'H':
            ...
            init_agent("ifTable"); /* register our .conf
                                      handlers */
            init_snmp("ifTable");
